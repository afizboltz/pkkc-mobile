            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <View style={{ padding: 12, borderWidth: 1, borderColor: '#ccc', borderRadius: 8, marginVertical: 6 }}>
                        ...
                        <Text>{t('amount')}: RM {item.amount || 'N/A'}.00</Text>
                        ...
                        {item.screenshotUrl ? (
                            <TouchableOpacity onPress={() => setPreviewUrl(item.screenshotUrl)} style={{ marginTop: 8, alignSelf: 'flex-start', paddingVertical: 6, paddingHorizontal: 10, backgroundColor: '#f1f5f9', borderRadius: 6 }}>
